...
} from "@buhler/features/line-machine/components/line-machine-overview/line-machine-overview.component";
import {
    LineMachineNavigationComponent
} from "@buhler/features/line-machine/components/line-machine-navigation/line-machine-navigation.component";
import {
    ErrorDescriptionComponent
} from "@buhler/features/line-machine/components/error-description/error-description.component";
...
@Component({
    ...
    imports: [MachineItemComponent, AsyncPipe, NgFor, NavigationItemComponent, MachineStateWrapperComponent, NgIf, RouterOutlet, LineMachineOverviewComponent, LineMachineNavigationComponent, ErrorDescriptionComponent],
